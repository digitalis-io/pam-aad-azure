...
ACLOCAL = ${SHELL} /github/pam-aad-azure/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
AUTOCONF = ${SHELL} /github/pam-aad-azure/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /github/pam-aad-azure/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /github/pam-aad-azure/build-aux/missing automake-1.16
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /github/pam-aad-azure/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
STRIP = strip
VERSION = 0.0.1
abs_builddir = /github/pam-aad-azure
abs_srcdir = /github/pam-aad-azure
abs_top_builddir = /github/pam-aad-azure
abs_top_srcdir = /github/pam-aad-azure
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /github/pam-aad-azure/build-aux/install-sh
libdir = $(PAMDIR)
